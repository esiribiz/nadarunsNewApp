  ...
  Widget build(BuildContext context) {
    return Html(
      ...
      style: {
        ...
        "tr": Style(border: Border(bottom: BorderSide(color: Colors.black45.withValues(alpha:0.5)))),
        "th": Style(padding: .all(6), backgroundColor: Colors.black45.withValues(alpha:0.5)),
