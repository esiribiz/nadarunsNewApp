                ...
                children: [
                  Text(
                    ...
                    style: primaryTextStyle(
                        color: !widget.data!.isMe.validate() ? Colors.blueGrey.withValues(alpha:0.6) : whiteColor.withValues(alpha:0.6), size: 10),
                  ),
                  2.width,
                  widget.data!.isMe!
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          time,
                          style: primaryTextStyle(
                            color: !widget.data!.isMe.validate() ? Colors.blueGrey.withValues(alpha:0.6) : whiteColor.withValues(alpha:0.6),
                            size: 10,
                          ),
                        ),
                        2.width,
