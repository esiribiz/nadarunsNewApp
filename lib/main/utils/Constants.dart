...
const googleMapAPIKey = 'AIzaSyCm_A2yMaW6HF-PTFnu-AuSvkWLCJMHtyM';
//endregion

// region onesignal keys
const mOneSignalAppId = 'db6750b7-e536-4bbf-9ec9-ad539dccf36e';
const mOneSignalRestKey = 'cac5vrfekuttvj32pdhoew266';
const mOneSignalChannelId = 'c8432b22-906f-4c12-83d3-24a96236a472';
//endregion

//region  firebase data  for firebase_options.dart
const String FIREBASE_API_KEY = "AIzaSyB4rQYgL_7OXlGbBEYStgcq9WI8kX05cNs";
const String FIREBASE_APP_ID = "1:974587081017:android:9befcc811f915292fc38e8";
const String FIREBASE_MESSAGING_SENDER_ID = "974587081017";
const String FIREBASE_PROJECT_ID = "nadaruns-369cc";
const String FIREBASE_STORAGE_BUCKET = "nadaruns-369cc.firebasestorage.app";

//region  firebase data  for firebase_options.dart FOR IOS APP USE
// TODO: Replace with your iOS Firebase App ID when you add the iOS app in Firebase Console
const String FIREBASE_APP_ID_IOS = "1:974587081017:ios:4667ca5046c351dbfc38e8";

//for ios
const String ANDROID_CLIENT_ID = '974587081017-kc02ppr45glbj6548bvfb83a5kdfn2dj.apps.googleusercontent.com';
const String IOS_CLIENT_ID = '974587081017-nnk88509ebqr837ut2e94fu1fq048buu.apps.googleusercontent.com';
const String IOS_BUNDLE_ID = 'com.nadaruns.delivery';
//endregion

//region languages and phone code
//const defaultLanguageCode = "en";
const defaultPhoneCode = '+358';
//endregion

//region country symnbol and code
const CURRENCY_SYMBOL = '€';
const CURRENCY_CODE = 'FIN';
//endregion
final mPrivacyPolicy = "$DOMAIN_URL/privacypolicy";
final mTermAndCondition = "$DOMAIN_URL/termofservice";
//endregion

const mInvoiceCompanyName = 'NadaRuns Oy';
const mInvoiceAddress = 'Helsinki, Finland';
const mInvoiceContactNumber = '+358 000000000';
