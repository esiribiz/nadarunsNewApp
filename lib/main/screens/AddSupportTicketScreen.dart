                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      initialValue: (widget.orderId != null && widget.orderId != 0) ? supportTypeForOrdersOnly[0] : supportType[0],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      20.width,
                      Container(height: 38, decoration: boxDecorationWithRoundedCorners(border: Border.all(color: Colors.grey.withValues(alpha:0.2)), backgroundColor: Colors.transparent), child: Text(language.video, style: boldTextStyle(size: 12)).paddingAll(6).center()).onTap(() async {
                        video = null;
