...
mixin _$AppStore on _AppStore, Store {
  ...
  late final _$followSystemThemeAtom = Atom(
    name: '_AppStore.followSystemTheme',
    context: context,
  );

  @override
  bool get followSystemTheme {
    _$followSystemThemeAtom.reportRead();
    return super.followSystemTheme;
  }

  @override
  set followSystemTheme(bool value) {
    _$followSystemThemeAtom.reportWrite(value, super.followSystemTheme, () {
      super.followSystemTheme = value;
    });
  }
  ...
  late final _$setSystemThemeAsyncAction = AsyncAction(
    '_AppStore.setSystemTheme',
    context: context,
  );

  @override
  Future<void> setSystemTheme() {
    return _$setSystemThemeAsyncAction.run(() => super.setSystemTheme());
  }
