                    ...
                    itemBuilder: (_, index) {
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border.all(color: Colors.grey.withValues(alpha:0.4)), borderRadius: BorderRadius.circular(defaultRadius)),
                        child: Row(
                          children: [
                            Expanded(
                              child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                        decoration: boxDecorationDefault(
                                            border: Border.all(color: Colors.grey.withValues(alpha:0.2)), color: Colors.transparent),
