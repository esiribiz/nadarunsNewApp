  ...
  Future<void> _confirmDelivery() async {
    ...
    try {
      if (widget.onConfirmDelivery != null) {
        await Future.sync(() => widget.onConfirmDelivery!.call());
      } else if (widget.order.id != null) {
        await updateOrder(orderStatus: ORDER_DELIVERED, orderId: widget.order.id!);
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '\$${(widget.order.earnings ?? 0).toStringAsFixed(2)}',
